...
def main():
    ...
    print(f"Key personnel found: {len(dossier.key_personnel)}")
    print(f"Locations found: {len(dossier.locations)}")
    print(f"Products/services found: {len(dossier.products_services)}")
